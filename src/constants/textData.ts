export default class AboutPageData {

    public static readonly title: string = "About";

    public static readonly subtitle: string = "Get to know my background, goals, and interests.";

    public static readonly introduction: string = 
    ...
    public static readonly goals: string = 
    ...
    public static readonly interests: string = 
